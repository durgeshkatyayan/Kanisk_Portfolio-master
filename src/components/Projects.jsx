...
const ProjectCard = ({
  ...
  return (
    <motion.div
      ...
      h-[420px] cursor-pointer card-shadow transition-all duration-500 ease-out
      ...
      {active !== id ? (
        <motion.div 
          className="flex items-center justify-start pr-[4.5rem]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          {/* Hover indicator */}
          <motion.div
            className="absolute bottom-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-opacity"
            initial={{ x: -10 }}
        ...
        <>
          ...
          <motion.div
            ...
            flex-col bg-gradient-to-t from-[rgba(20,20,20,0.95)] via-[rgba(60,60,60,0.7)] to-transparent
            rounded-b-[24px] z-20 backdrop-blur-sm">
            ...
            <div className="absolute inset-0 flex justify-end m-3 gap-3">
              <motion.div
                ...
                className="bg-gradient-to-br from-night to-battleGray sm:w-11 sm:h-11 w-10 h-10 rounded-full 
              ...
              <motion.div
                ...
                whileTap={{ scale: 0.9 }}
                className="bg-gradient-to-br from-yellow-500 to-orange-500 sm:w-11 sm:h-11 w-10 h-10 rounded-full 
                flex justify-center items-center cursor-pointer
            ...
            <motion.h2
              ...
              <motion.div
                ...
                className="h-1 bg-gradient-to-r from-battleGray via-taupe to-silver mt-2 rounded-full"></motion.div>
            </motion.h2>
                ...
                {tags.map((tag, idx) => {
                  ...
                  return (
                    <span
                      ...
                      className={`px-3 py-1 text-xs font-medium text-timberWolf ${
                        typeof tag === 'string' 
            ...
            <motion.button
              ...
              shadow-lg hover:shadow-taupe/50"
              onClick={(e) => {
                e.stopPropagation();
              ...
              <motion.img
                ...
                src={pineapple}
                alt="pineapple"
                className={`btn-icon-${id} sm:w-[34px] sm:h-[34px] 
  ...
  return (
    <div className="-mt-[6rem]">
      ...
      <motion.div 
        ...
        className="relative">
        <div className="absolute -top-20 -left-20 w-72 h-72 bg-taupe/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute -top-20 -right-20 w-72 h-72 bg-battleGray/30 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3 }}
        className="mt-8 flex flex-col lg:flex-row gap-4 items-start lg:items-center justify-between">
        ...
        <div className="flex flex-wrap gap-3">
          {categories.map((tech) => (
            <motion.button
              ...
              className={`px-4 py-2 rounded-full font-beckman text-sm uppercase tracking-wider
                transition-all duration-300 flex items-center gap-2 ${
                filter === tech.name
                  ? `bg-gradient-to-r ${tech.color} text-white shadow-lg shadow-${tech.color}/30 border-2 border-white/20`
        ...
        <div className="flex gap-3 items-center">
          ...
          <div className="relative">
            <input
              ...
              className="bg-night/50 border-2 border-battleGray/30 text-timberWolf px-4 py-2 rounded-full
                focus:outline-none focus:border-taupe/50 w-[200px] sm:w-[250px]
                placeholder-taupe/50 transition-all duration-300 backdrop-blur-sm"
            />
            <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-taupe/70" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <motion.button
            ...
            className="bg-night/50 border-2 border-battleGray/30 p-2 rounded-full
              hover:border-taupe/50 transition-all duration-300 backdrop-blur-sm">
            <svg className="w-6 h-6 text-timberWolf" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              {viewMode === 'expanded' ? (
      ...
      <AnimatePresence mode="wait">
        {viewMode === 'expanded' ? (
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="mt-[50px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredProjects.map((proj, index) => (
              <motion.div
                key={proj.id}
                initial={{ opacity: 0, y: 20 }}
                ...
                className="bg-gradient-to-br from-night to-jetLight rounded-[24px] overflow-hidden
                  ...
                  group hover:shadow-xl hover:shadow-taupe/20">
                ...
                <div className="p-6">
                  <h3 className="text-timberWolf font-beckman text-xl uppercase mb-2">{proj.name}</h3>
                  <p className="text-taupe text-sm mb-4 line-clamp-3">{proj.description}</p>
                  {proj.tags && (
                      ...
                      {proj.tags.slice(0, 3).map((tag, idx) => {
                        ...
                        return (
                          <span 
                            ...
                            } bg-battleGray/30 border border-taupe/20`}>
                  ...
                  <div className="flex gap-3">
                    <motion.button
                      ...
                      className="flex-1 bg-battleGray/50 hover:bg-battleGray/70 text-timberWolf py-2 rounded-lg transition-colors border border-taupe/20">
                      Code
                    </motion.button>
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      ...
                      className="flex-1 bg-gradient-to-r from-battleGray to-taupe text-timberWolf py-2 rounded-lg
                        hover:from-taupe hover:to-battleGray transition-all border border-silver/30">
                      Demo
                    </motion.button>
                  </div>
                </div>
      ...
      {filteredProjects.length === 0 && (
        <motion.div
          ...
          <p className="text-taupe text-xl">No projects found matching your criteria.</p>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            onClick={() => {
            ...
            className="mt-4 px-6 py-2 bg-battleGray/50 text-timberWolf rounded-full
              border border-taupe/30 hover:border-taupe/50 transition-all">
            Clear Filters
          </motion.button>
        </motion.div>
      )}
      ...
      <motion.div
        ...
        <h2 className="text-timberWolf font-beckman text-3xl sm:text-4xl uppercase relative z-10">
